...
// configuration step. It creates a namespace called `learn_make`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", learn_make::cmake::project_name, learn_make::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", learn_make::cmake::project_version);
      return EXIT_SUCCESS;
    }
